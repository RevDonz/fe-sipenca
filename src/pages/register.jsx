  ...
  return (
    <div className="min-h-screen w-full flex justify-center items-center bg-[#E1EBF3]">
      <div className="bg-white rounded-lg w-96 p-5">
        ...
        {/*inputbox email*/}
        <div className="bg-gray-200 rounded-md mt-2 w-full px-3 py-2 focus-within:bg-purple-100">
          {" "}
          ...
          <input
            ...
            name="email"
            id="email"
            className="w-full pl-8 bg-gray-200 focus:outline-none focus:bg-purple-100"
        ...
        {/*inputbox role*/}
        <div className="bg-gray-200 rounded-md mt-2 w-full px-3 py-2 focus-within:bg-purple-100 peer">
          {" "}
          ...
          <button
            ...
            className="w-full text-gray-400 text-left pl-8 focus"
          >
            Role
          </button>
          {/*dropdown menu*/}
